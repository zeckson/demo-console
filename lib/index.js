...
(function(global) {
  ...
  if (!global.HtmlacademyTask) {
    throw Error('HtmlacademyTask is missing in Global scope');

  } else {
    global.HtmlacademyTask.jsConsoleInit = HtmlacademyTask.jsConsoleInit || jsConsoleInit;
    global.HtmlacademyTask.syntaxHighlight = HtmlacademyTask.syntaxHighlight || jsConsoleInit;
  }
