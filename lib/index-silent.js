...
(function (global) {
  ...
  global.onload = function () {
    ...
    template.innerHTML = '<div class="console-container"></div>' +
      '<style> @import url(\'//htmlacademy.github.io/console-stub/lib/index.css\'); </style>';
    global.document.body.appendChild(template.content.firstChild);

    var jsConsole = jsConsoleInit(global.document.querySelector('.console-container'));
    global.onerror = function (err) {
      jsConsole.log(err);
    };
    global.console.log = jsConsole.log;
    global.console.error = jsConsole.log;
    global.console.info = jsConsole.log;
    global.console.debug = jsConsole.log;
  }
